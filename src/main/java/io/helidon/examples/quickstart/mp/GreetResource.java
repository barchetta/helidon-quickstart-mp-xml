...
public class GreetResource {
    ...
    public Response postIt(JsonObject jsonObject){
        Product prod = new Product();
        prod.setName(jsonObject.getString("greeting"));
        prod.setId(1234);
        prod.setDescription("Just a Hello");
        prod.setPrice(0);
        Response response = Response.status(Response.Status.OK).entity(prod).build();
        return response;
    }
}